function drawMusic(){var e=(new THREE.HemisphereLight(8685445,3947833,2.18),new THREE.Mesh(floorGeometry,floorMaterial));e.position.y=100,e.rotation.x=Math.PI/2,makeParticles()}function makeParticles(){function e(n){n.x>-80&&n.x<80&&n.y>-80&&n.y<80&&(n.x=1e3*Math.random()-500,n.y=1e3*Math.random()-500,e(n))}function n(e){var n={x:.01},a=new TWEEN.Tween(n).to({x:1},500),o={z:0},t=new TWEEN.Tween(o).to({z:-3.14159},500),s={y:0},i=new TWEEN.Tween(s).to({y:100},500),r={x:0},d=new TWEEN.Tween(r).to({x:100},500),c={y:0},l=new TWEEN.Tween(c).to({y:-100},500),u={x:0},p=new TWEEN.Tween(u).to({x:-100},500);a.onUpdate(function(){e.children[0].scale.set(n.x,n.x,n.x),e.children[1].scale.set(n.x,n.x,n.x),e.children[2].scale.set(n.x,n.x,n.x),e.children[3].scale.set(n.x,n.x,n.x)}),a.start(),t.onUpdate(function(){e.rotation.z=o.z}),t.start(),i.onUpdate(function(){e.children[0].position.y=s.y}),i.start(),d.onUpdate(function(){e.children[1].position.x=r.x}),d.start(),l.onUpdate(function(){e.children[2].position.y=c.y}),l.start(),p.onUpdate(function(){e.children[3].position.x=u.x}),p.start()}function a(e){var n={x:1},a=new TWEEN.Tween(n).to({x:.01},500),o={z:-3.14159},t=new TWEEN.Tween(o).to({z:0},500),s={y:100},i=new TWEEN.Tween(s).to({y:0},500),r={x:100},d=new TWEEN.Tween(r).to({x:0},500),c={y:-100},l=new TWEEN.Tween(c).to({y:0},500),u={x:-100},p=new TWEEN.Tween(u).to({x:0},500);a.onUpdate(function(){e.children[0].scale.set(n.x,n.x,n.x),e.children[1].scale.set(n.x,n.x,n.x),e.children[2].scale.set(n.x,n.x,n.x),e.children[3].scale.set(n.x,n.x,n.x)}),a.start(),t.onUpdate(function(){e.rotation.z=o.z}),t.start(),i.onUpdate(function(){e.children[0].position.y=s.y}),i.start(),d.onUpdate(function(){e.children[1].position.x=r.x}),d.start(),l.onUpdate(function(){e.children[2].position.y=c.y}),l.start(),p.onUpdate(function(){e.children[3].position.x=u.x}),p.start()}function o(e){function n(){var e={x:1},n=new TWEEN.Tween(e).to({x:.01},500),a={z:-3.14159},t=new TWEEN.Tween(a).to({z:0},500),s={y:100},i=new TWEEN.Tween(s).to({y:0},500),r={x:100},d=new TWEEN.Tween(r).to({x:0},500),c={y:-100},l=new TWEEN.Tween(c).to({y:0},500),u={x:-100},p=new TWEEN.Tween(u).to({x:0},500);n.onUpdate(function(){o.children[0].scale.set(e.x,e.x,e.x),o.children[1].scale.set(e.x,e.x,e.x),o.children[2].scale.set(e.x,e.x,e.x),o.children[3].scale.set(e.x,e.x,e.x)}),n.start(),t.onUpdate(function(){o.rotation.z=a.z}),t.start(),i.onUpdate(function(){o.children[0].position.y=s.y}),i.start(),d.onUpdate(function(){o.children[1].position.x=r.x}),d.start(),l.onUpdate(function(){o.children[2].position.y=c.y}),l.start(),p.onUpdate(function(){o.children[3].position.x=u.x}),p.start()}for(var a=window[e.sound],o=new THREE.Group,t=0;4>t;t++){var s=new THREE.CircleGeometry(25,32),i=new THREE.MeshBasicMaterial({color:8716543,transparent:!0,opacity:.75}),r=new THREE.Mesh(s,i);r.buttonId=t;var d=new THREE.CircleGeometry(5,32),c=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.75}),l=new THREE.Mesh(d,c),u=new THREE.Group;switch(t){case 0:break;case 1:var p=new THREE.Mesh(d,c);l.position.x=-8,p.position.x=8,u.add(p);break;case 2:var p=new THREE.Mesh(d,c),h=new THREE.Mesh(d,c);l.position.y=8,p.position.x=-8,h.position.x=8,p.position.y=-4,h.position.y=-4,u.add(p),u.add(h);break;case 3:var p=new THREE.Mesh(d,c),h=new THREE.Mesh(d,c),w=new THREE.Mesh(d,c);l.position.x=-11,p.position.x=11,h.position.y=-11,w.position.y=11,u.add(p),u.add(h),u.add(w)}u.add(l),u.position.z=.1,r.add(u),Reticulum.add(r,{onGazeOver:function(){if(o.parent.tempoVisible){this.parent.parent.hovered=!0;var e={x:1,y:1,a:.5},n=new TWEEN.Tween(e).to({x:2,y:2,a:1},750).easing(TWEEN.Easing.Elastic.Out),a=this;n.onUpdate(function(){a.scale.x=e.x,a.scale.y=e.y,a.material.opacity=e.a}),n.start()}},onGazeOut:function(){if(this.parent.parent.hovered=!1,o.parent.tempoVisible){var e={x:2,y:2,a:1},n=new TWEEN.Tween(e).to({x:1,y:1,a:.5},750).easing(TWEEN.Easing.Elastic.Out),a=this;n.onUpdate(function(){a.scale.x=e.x,a.scale.y=e.y,a.material.opacity=e.a}),n.start()}},onGazeLong:function(){n(),this.parent.parent.tempoVisible=!1,playLoopedSound(a,this)}}),o.add(r)}e.add(o),e.hasTempo=!0}function t(e,n){var a={x:.01,y:.01,z:.01},o=new TWEEN.Tween(a).to({x:1,y:1,z:1},750).easing(TWEEN.Easing.Elastic.Out);setTimeout(function(){var n=e;o.onUpdate(function(){n.scale.set(a.x,a.y,a.z)}),o.start()},n)}for(var s,i=new THREE.MeshLambertMaterial({color:8716543,wireframe:!0,transparent:!0}),r=new THREE.MeshPhongMaterial({color:16777215,overdraw:.5,shading:THREE.FlatShading}),d=[r,i],c=0,l=-1500;1500>l;l+=20){if(0==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.OctahedronGeometry(20,0),d);if(1==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.IcosahedronGeometry(20,0),d);if(2==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.TetrahedronGeometry(20,0),d);if(3==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.CubeGeometry(20,20,20,1,1,1),d);if(4==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.CylinderGeometry(0,20,50,4,4),d);if(5==c)var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.IcosahedronGeometry(20,1),d);5>c?c+=1:c=0;var u=new THREE.ShaderMaterial({uniforms:{c:{type:"f",value:.88},p:{type:"f",value:6.04},glowColor:{type:"c",value:new THREE.Color(9896191)},viewVector:{type:"v3",value:camera.position}},vertexShader:document.getElementById("vertexShader").textContent,fragmentShader:document.getElementById("fragmentShader").textContent,side:THREE.FrontSide,blending:THREE.AdditiveBlending,transparent:!0});this.glow=new THREE.Mesh(s.children[0].geometry.clone(),u.clone()),glow.position=s.position,glow.scale.multiplyScalar(1.13),glow.visible=!1,s.add(glow),s.scale.set(.001,.001,.001),s.position.x=1e3*Math.random()-500,s.position.y=1e3*Math.random()-500,e(s.position),s.position.z=l,scene.add(s),particles.push(s)}for(var p=0;p<particles.length;p++){var h=getRandomInt(0,6.2),w=getRandomInt(0,6.2),E=getRandomInt(0,6.2);particles[p].children[0].rotation.set(h,w,E),particles[p].children[1].rotation.set(h,w,E),particles[p].children[1].scale.set(.01,.01,.01),particles[p].children[2].rotation.set(h,w,E),particles[p].sound=chooseRandomSound(),particles[p].playing=!1,particles[p].action=0,particles[p].hasTempo=!1,particles[p].tempoVisible=!1,Reticulum.add(particles[p].children[0],{onGazeOver:function(){shapeHover(this);var e=window[this.parent.sound],n=e._context,a=e._source,o=e._panner;o.panningModel="HRTF",o.refDistance=150,a.connect(o),o.connect(n.destination),e.play()},onGazeOut:function(){this.parent.action=0,shapeStopHover(this)},onGazeLong:function(){this.parent.action+=1,this.parent.hasTempo||o(this.parent),1==this.parent.action&&(this.parent.playing||this.parent.tempoVisible?!this.parent.playing&&this.parent.tempoVisible&&(this.parent.tempoVisible=!1,a(this.parent.children[3])):(this.parent.tempoVisible=!0,n(this.parent.children[3])),explode(this.parent.children[1],this.parent.sound))}})}for(var y=0;y<scene.children.length;y++)if(.001==scene.children[y].scale.x){var x=100*y;scene.children[y];t(scene.children[y],x)}}function shapeHover(e){e.parent.hovered=!0;var n={x:1,y:1,z:1},a=new TWEEN.Tween(n).to({x:1.5,y:1.5,z:1.5},200);a.onUpdate(function(){e.scale.set(n.x,n.y,n.z),e.parent.children[2].scale.set(n.x,n.y,n.z)}),a.start()}function shapeStopHover(e){e.parent.hovered=!1;var n={x:1.5,y:1.5,z:1.5},a=new TWEEN.Tween(n).to({x:1,y:1,z:1},200);a.onUpdate(function(){e.scale.set(n.x,n.y,n.z),e.parent.children[2].scale.set(n.x,n.y,n.z)}),a.start()}function explode(e,n){var a={x:4,y:4,z:4},o=new TWEEN.Tween(a).to({x:1,y:1,z:1},750).easing(TWEEN.Easing.Elastic.In);n=window[n],e.parent.playing?(e.parent.playing=!1,sound8.play(),3!==scene.step?e.parent.children[3].visible||(o.onUpdate(function(){e.scale.set(a.x,a.y,a.z)}),o.start()):e.parent.children[2].visible||(o.onUpdate(function(){e.scale.set(a.x,a.y,a.z)}),o.start())):n.play()}function playLoopedSound(e,n){var a,o=n.buttonId;if(3!==scene.step)var t={x:4,y:4,z:4},s=new TWEEN.Tween(t).to({x:.01,y:.01,z:.01},750).easing(TWEEN.Easing.Elastic.In),i={x:1,y:1,z:1},r=new TWEEN.Tween(i).to({x:4,y:4,z:4},750).easing(TWEEN.Easing.Elastic.Out);else var t={x:1.5,y:1.5,z:1.5},s=new TWEEN.Tween(t).to({x:.01,y:.01,z:.01},750).easing(TWEEN.Easing.Elastic.In),i={x:1,y:1,z:1},r=new TWEEN.Tween(i).to({x:1.5,y:1.5,z:1.5},750).easing(TWEEN.Easing.Elastic.Out);a=0==o?4e3:1==o?2e3:2==o?1e3:500,setTimeout(function(){function o(){n.parent.parent.playing||(a=0),setTimeout(function(){n.parent.parent.playing&&(e.play(),o()),n.parent.parent.playing||(s.onUpdate(function(){n.parent.parent.children[1].scale.set(t.x,t.y,t.z)}),s.start(),3!==scene.step&&n.parent.parent.children[4]&&(n.parent.parent.children[4].intensity=0,n.parent.parent.children[2].visible=!1))},a)}if(n.parent.parent.playing=!0,e.play(),r.onUpdate(function(){n.parent.parent.children[1].scale.set(i.x,i.y,i.z)}),r.start(),3!==scene.step){var d=new THREE.PointLight(3342438,10.76,500);n.parent.parent.add(d)}n.parent.parent.children[2].visible=!0,o()},500)}function chooseRandomSound(){var e=getRandomInt(1,30),n="sound"+e.toString();return n}function getRandomInt(e,n){return Math.floor(Math.random()*(n-e+1))+e}function updateParticles(){var e,n,a,o=TWEEN.Easing.Linear.None;n=camera.getWorldDirection(),a=new THREE.Vector3(0,1,0).applyEuler(camera.getWorldRotation());for(var t=0;t<particles.length;t++){particle=particles[t],particle.hovered||(particle.position.z+=1),particle.children.length>=4&&particle.children[3].lookAtWorld(camera.getWorldPosition()),particle.children[0].rotation.x+=.025,particle.children[0].rotation.z+=.025,particle.children[1].rotation.x+=.025,particle.children[1].rotation.z+=.025,particle.children[2].rotation.x+=.025,particle.children[2].rotation.z+=.025,particle.position.z>2e3&&(particle.position.z-=3e3);var e=window[particle.sound];if(particle.playing){var s=e.amplitude();s=o(s),particle.children[0].scale.set(1+1.1*s,1+1.1*s,1+1.1*s),particle.children[2].scale.set(1.13+1.1*s,1.13+1.1*s,1.13+1.1*s),particle.children[4].intensity=2+5*s}e._context.listener.setOrientation(n.x,n.y,n.z,a.x,a.y,a.z),e._panner.setPosition(particle.position.x,particle.position.y,particle.position.z)}if(scene.tutorial){scene.children[5].children[0].rotation.y+=.025,scene.children[5].children[1].rotation.y+=.025,scene.children[5].children[2].rotation.y+=.025,scene.children[5].children[3].rotation.y+=.025;for(var t=0;4>t;t++)if(3==scene.children[5].children[t].children.length&&scene.children[5].children[t].children[2].lookAtWorld(camera.getWorldPosition()),scene.children[5].children[t].playing){var e=window[scene.children[5].children[t].sound],s=e.amplitude();s=o(s),scene.children[5].children[t].children[0].scale.set(1+1.1*s,1+1.1*s,1+1.1*s),scene.children[5].children[t].children[1].scale.set(3,3,3)}if(!(scene.children[5].children[0].hovered||scene.children[5].children[1].hovered||scene.children[5].children[2].hovered||scene.children[5].children[3].hovered))for(var t=0;4>t;t++)0==scene.children[5].direction&&(scene.children[5].children[t].position.y+=-.007),1==scene.children[5].direction&&(scene.children[5].children[t].position.y+=.007),scene.children[5].children[t].position.y<-.5&&(scene.children[5].direction=1),scene.children[5].children[t].position.y>1&&(scene.children[5].direction=0)}}var particles=[];THREE.Object3D.prototype.lookAtWorld=function(e){this.parent.worldToLocal(e),this.lookAt(e)};var webaudio=new WebAudio,sound1=webaudio.createSound(),sound2=webaudio.createSound(),sound3=webaudio.createSound(),sound4=webaudio.createSound(),sound5=webaudio.createSound(),sound6=webaudio.createSound(),sound7=webaudio.createSound(),sound8=webaudio.createSound(),sound9=webaudio.createSound(),sound10=webaudio.createSound(),sound11=webaudio.createSound(),sound12=webaudio.createSound(),sound13=webaudio.createSound(),sound14=webaudio.createSound(),sound15=webaudio.createSound(),sound16=webaudio.createSound(),sound17=webaudio.createSound(),sound18=webaudio.createSound(),sound19=webaudio.createSound(),sound20=webaudio.createSound(),sound21=webaudio.createSound(),sound22=webaudio.createSound(),sound23=webaudio.createSound(),sound24=webaudio.createSound(),sound25=webaudio.createSound(),sound26=webaudio.createSound(),sound27=webaudio.createSound(),sound28=webaudio.createSound(),sound29=webaudio.createSound(),sound30=webaudio.createSound(),sound666=webaudio.createSound();WebAudio.Flow().par(function(e){sound1.load("assets/audio/Feb13_004.wav",e)}).par(function(e){sound2.load("assets/audio/Feb13_010.wav",e)}).par(function(e){sound3.load("assets/audio/Feb13_013.wav",e)}).par(function(e){sound4.load("assets/audio/Feb13_214.wav",e)}).par(function(e){sound5.load("assets/audio/Feb13_218.wav",e)}).par(function(e){sound6.load("assets/audio/Feb13_025.wav",e)}).par(function(e){sound7.load("assets/audio/Feb13_028.wav",e)}).par(function(e){sound8.load("assets/audio/Feb13_029.wav",e)}).par(function(e){sound9.load("assets/audio/Feb13_034.wav",e)}).par(function(e){sound10.load("assets/audio/Feb13_035.wav",e)}).par(function(e){sound11.load("assets/audio/Feb13_044.wav",e)}).par(function(e){sound12.load("assets/audio/Feb13_045.wav",e)}).par(function(e){sound13.load("assets/audio/Feb13_049.wav",e)}).par(function(e){sound14.load("assets/audio/Feb13_051.wav",e)}).par(function(e){sound15.load("assets/audio/Feb13_057.wav",e)}).par(function(e){sound16.load("assets/audio/Feb13_058.wav",e)}).par(function(e){sound17.load("assets/audio/Feb13_072.wav",e)}).par(function(e){sound18.load("assets/audio/Feb13_074.wav",e)}).par(function(e){sound19.load("assets/audio/Feb13_087.wav",e)}).par(function(e){sound20.load("assets/audio/Feb13_092.wav",e)}).par(function(e){sound21.load("assets/audio/Feb13_103.wav",e)}).par(function(e){sound22.load("assets/audio/Feb13_108.wav",e)}).par(function(e){sound23.load("assets/audio/Feb13_111.wav",e)}).par(function(e){sound24.load("assets/audio/Feb13_120.wav",e)}).par(function(e){sound25.load("assets/audio/Feb13_125.wav",e)}).par(function(e){sound26.load("assets/audio/Feb13_131.wav",e)}).par(function(e){sound27.load("assets/audio/Feb13_133.wav",e)}).par(function(e){sound28.load("assets/audio/Feb13_161.wav",e)}).par(function(e){sound29.load("assets/audio/Feb13_167.wav",e)}).par(function(e){sound30.load("assets/audio/Feb13_170.wav",e)}).par(function(e){sound666.load("assets/audio/Feb13_171.wav",e)}).seq(function(){console.assert(sound1.isPlayable()),console.assert(sound2.isPlayable()),console.assert(sound3.isPlayable()),console.assert(sound4.isPlayable()),console.assert(sound5.isPlayable()),console.assert(sound6.isPlayable()),console.assert(sound7.isPlayable()),console.assert(sound8.isPlayable()),console.assert(sound9.isPlayable()),console.assert(sound10.isPlayable()),console.assert(sound11.isPlayable()),console.assert(sound12.isPlayable()),console.assert(sound13.isPlayable()),console.assert(sound14.isPlayable()),console.assert(sound15.isPlayable()),console.assert(sound16.isPlayable()),console.assert(sound17.isPlayable()),console.assert(sound18.isPlayable()),console.assert(sound19.isPlayable()),console.assert(sound20.isPlayable()),console.assert(sound21.isPlayable()),console.assert(sound22.isPlayable()),console.assert(sound23.isPlayable()),console.assert(sound24.isPlayable()),console.assert(sound25.isPlayable()),console.assert(sound26.isPlayable()),console.assert(sound27.isPlayable()),console.assert(sound28.isPlayable()),console.assert(sound29.isPlayable()),console.assert(sound30.isPlayable()),console.assert(sound666.isPlayable()),console.log("sounds loaded")});
function switchLightsOff(){createjs.Tween.get(lightSphere.material,{}).to({opacity:1},1500,createjs.Ease.sineIn)}function switchLightsOn(){createjs.Tween.get(lightSphere.material,{}).to({opacity:0},1500,createjs.Ease.sineIn)}function clearScene(e){var t=scene.getObjectByName(e);scene.remove(t)}function showTitle(e,t){var n=new THREE.Group;n.name="title";var a=new THREE.PlaneGeometry(.4,.16),r=new THREEx.DynamicTexture(2500,1e3);r.context.font="300px 'source-sans-pro'",r.drawText(e,void 0,250,"white");var i=new THREE.MeshBasicMaterial({map:r.texture,transparent:!0}),e=new THREE.Mesh(a,i);e.position.z=-1,n.add(e);var s=new THREE.PlaneGeometry(.4,.16),o=new THREEx.DynamicTexture(2500,1e3);o.context.font="200px 'source-sans-pro'",o.drawText(t,void 0,800,"white");var c=new THREE.MeshBasicMaterial({map:o.texture,transparent:!0}),t=new THREE.Mesh(s,c);t.position.z=-1,n.add(t);var E=new THREE.PlaneGeometry(.1,.005),w=new THREE.MeshBasicMaterial({color:8716543});rectangle=new THREE.Mesh(E,w),rectangle.position.z=-1,rectangle.position.y=.01,n.add(rectangle),scene.add(n)}
...
function drawPitchWorld(){var e=new THREE.Group;e.name="pitch";var t=(new THREE.AmbientLight(2631720),new THREE.HemisphereLight(16075054,12107312,1.5));e.add(t);var a=new THREE.Group;a.name="floor";for(var o=0;10>o;o++){for(var n=o/5+.5,r=360,s=new THREE.Line(new THREE.Geometry,new THREE.LineBasicMaterial({color:4359668,transparent:!0,opacity:0})),i=0;r>=i;i++){var c=Math.PI/180*i,h=n*Math.cos(c),p=n*Math.sin(c),E=0;s.geometry.vertices.push(new THREE.Vector3(h,p,E))}s.position.y=-.2,s.rotation.x=1.5708,a.add(s)}e.add(a),setTimeout(function(){function e(){createjs.Tween.get(a.children[t].material,{}).to({opacity:.5},500,createjs.Ease.sineIn),t++,o>t&&setTimeout(e,100)}var t=0,o=a.children.length;e()},750);var d=new THREE.Group;sphereMaterial=new THREE.MeshPhongMaterial({color:16777215,shading:THREE.FlatShading});var l=new THREE.IcosahedronGeometry(1.5,1);sphere=new THREE.Mesh(l,sphereMaterial),sphere.scale.set(.1,.1,.1),sphere.position.z=-1.5,sphere.rotation.x=1,d.add(sphere);var T=sphere.clone();T.position.x=1.12,T.position.z=-1.12,T.rotation.x=.2,d.add(T);var u=sphere.clone();u.position.x=-1.12,u.position.z=-1.12,u.rotation.x=-.2,d.add(u);var w=new THREEx.VertexAnimation(l,function(e,t,a,o){var n=5*o+10*t.z;t.y=e.y+.2*Math.cos(n),t.x=e.x+.2*Math.cos(n),t.z=e.z+Math.cos(n)/200});updateFcts.push(function(e,t){w.update(e,t)}),e.add(d),setTimeout(function(){new Howl({urls:["assets/audio/scales/level1.wav"]}).play();createjs.Tween.get(u.scale,{}).to({x:.12,y:.12,z:.12},150).to({x:.1,y:.1,z:.1},150),setTimeout(function(){createjs.Tween.get(sphere.scale,{}).to({x:.13,y:.13,z:.13},150).to({x:.1,y:.1,z:.1},150),setTimeout(function(){createjs.Tween.get(T.scale,{}).to({x:.14,y:.14,z:.14},150).to({x:.1,y:.1,z:.1},150)},1400)},1e3)},3e3),scene.add(e)}
function drawPrairie(){function e(e){var n={x:1,y:1,z:1},t=new TWEEN.Tween(n).to({x:1.3,y:1.3,z:1.3},100);t.onUpdate(function(){e.scale.set(n.x,n.y,n.z)}),t.start()}function n(e){var n={x:1.3,y:1.3,z:1.3},t=new TWEEN.Tween(n).to({x:1,y:1,z:1},100);t.onUpdate(function(){e.scale.set(n.x,n.y,n.z)}),t.start()}function t(t){scene.step=2,i(r.children[3]),i(r.children[4]),i(r.children[5]),i(r.children[2]),setTimeout(function(){Reticulum.remove(r.children[3].children[0]),Reticulum.remove(r.children[4].children[0]),Reticulum.remove(r.children[5].children[0]),Reticulum.remove(r.children[2].children[0])},500),setTimeout(function(){a(r.children[3],"In stitch, each sound is represented by a 3D shape.","You can select and play them just by looking at them."),a(r.children[4],"In stitch, each sound is represented by a 3D shape.","You can select and play them just by looking at them."),a(r.children[5],"In stitch, each sound is represented by a 3D shape.","You can select and play them just by looking at them."),a(r.children[2],"In stitch, each sound is represented by a 3D shape.","You can select and play them just by looking at them.")},1500),setTimeout(function(){function t(e){e.visible=!0,e.children[0].visible=!0,e.children[1].visible=!0,e.children[2].visible=!0,e.children[3].visible=!0;var n={x:.01},t=new TWEEN.Tween(n).to({x:1},500),i={z:0},a=new TWEEN.Tween(i).to({z:-3.14159},500),o={y:0},r=new TWEEN.Tween(o).to({y:.5},500),c={x:0},s=new TWEEN.Tween(c).to({x:.5},500),l={y:0},d=new TWEEN.Tween(l).to({y:-.5},500),h={x:0},p=new TWEEN.Tween(h).to({x:-.5},500);t.onUpdate(function(){e.children[0].scale.set(n.x,n.x,n.x),e.children[1].scale.set(n.x,n.x,n.x),e.children[2].scale.set(n.x,n.x,n.x),e.children[3].scale.set(n.x,n.x,n.x)}),t.start(),a.onUpdate(function(){e.rotation.z=i.z}),a.start(),r.onUpdate(function(){e.children[0].position.y=o.y}),r.start(),s.onUpdate(function(){e.children[1].position.x=c.x}),s.start(),d.onUpdate(function(){e.children[2].position.y=l.y}),d.start(),p.onUpdate(function(){e.children[3].position.x=h.x}),p.start()}scene.tutorial=!0;for(var i=new THREE.Group,a=new THREE.MeshBasicMaterial({color:8716543,wireframe:!0,transparent:!0}),o=new THREE.MeshPhongMaterial({color:16777215,overdraw:.5,shading:THREE.FlatShading}),r=[o,a],c=0;4>c;c++){if(0==c){var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.OctahedronGeometry(.2,0),r);s.position.z=-1.4,s.position.x=-1.4,s.sound="sound1"}if(1==c){var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.IcosahedronGeometry(.2,0),r);s.position.z=-1.4,s.position.x=1.4,s.sound="sound2"}if(2==c){var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.TetrahedronGeometry(.2,0),r);s.position.z=1.4,s.position.x=-1.4,s.sound="sound3"}if(3==c){var s=THREE.SceneUtils.createMultiMaterialObject(new THREE.CubeGeometry(.2,.2,.2,1,1,1),r);s.position.z=1.4,s.position.x=1.4,s.sound="sound4"}s.scale.set(.001,.001,.001),s.hovered=!1,s.action=0,s.playing=!1,s.hasTempo=!1,s.tempoVisible=!1,Reticulum.add(s.children[0],{clickCancelFuse:!1,reticleHoverColor:0,fuseVisible:!1,fuseDuration:1.5,fuseColor:0,onGazeOver:function(){s.hovered=!0,e(this);var n=this.parent.sound;n=window[n],n.play(),2==scene.step?scene.children[1].children[0].children[1].material.visible=!1:3==scene.step&&(scene.children[1].children[0].children[1].material.visible=!0)},onGazeOut:function(){this.parent.action=0,s.hovered=!1,n(this),2==scene.step?scene.children[1].children[0].children[1].material.visible=!0:3==scene.step&&(scene.children[1].children[0].children[1].material.visible=!0)},onGazeLong:function(){this.parent.action+=1,3==scene.step&&(this.parent.hasTempo||createTutTempoMenu(this.parent),1==this.parent.action&&(this.parent.playing||this.parent.tempoVisible?!this.parent.playing&&this.parent.tempoVisible&&(this.parent.tempoVisible=!0,t(this.parent.children[2])):(this.parent.tempoVisible=!0,t(this.parent.children[2])),explode(this.parent.children[1],this.parent.sound)))}}),i.add(s),s.children[1].scale.set(.01,.01,.01)}scene.add(i),setTimeout(function(){var e={x:.01,y:.01,z:.01},n=new TWEEN.Tween(e).to({x:1,y:1,z:1},1250).easing(TWEEN.Easing.Elastic.Out);n.onUpdate(function(){i.children[0].scale.set(e.x,e.y,e.z),i.children[1].scale.set(e.x,e.y,e.z),i.children[2].scale.set(e.x,e.y,e.z),i.children[3].scale.set(e.x,e.y,e.z)}),n.start(),scene.children[5].direction=0},750)},2e3)}function i(e){e.traverse(function(e){if(e.hidden=!1,e.material&&1==e.material.opacity){e.hidden=!0;var n={a:1},t=new TWEEN.Tween(n).to({a:0},1e3);t.onUpdate(function(){e.material.opacity=n.a}),t.start(),setTimeout(function(){e.parent.remove(e)},1e3)}})}function a(t,i,a){var r=new THREE.Group,s=new THREE.Mesh(H,b);s.position.y=.12;var l=new THREE.PlaneGeometry(.6,.15),d=new THREEx.DynamicTexture(4e3,1e3);d.context.font="150px 'source-sans-pro'",d.context.strokeStyle="#ffffff",d.drawText(i,void 0,600,"white");var h=new THREE.MeshBasicMaterial({map:d.texture,transparent:!0}),p=new THREE.Mesh(l,h);p.material.color.r=255,p.material.color.g=255,p.material.color.b=255,p.position.z=.01,p.material.transparent=!0,p.material.opacity=0,p.hidden=!0,s.add(p),r.add(s);var f=new THREE.Mesh(H,b);f.position.y=.02;var m=new THREEx.DynamicTexture(3500,1e3);m.context.font="150px 'source-sans-pro'",m.context.strokeStyle="#ffffff",m.drawText(a,void 0,600,"white");var w=new THREE.MeshBasicMaterial({map:m.texture,transparent:!0}),x=new THREE.Mesh(l,w);x.material.color.r=255,x.material.color.g=255,x.material.color.b=255,x.position.z=.01,x.material.transparent=!0,x.material.opacity=0,x.hidden=!0,f.add(x),r.add(f);var y=new THREE.Mesh(u,E);y.position.z=.02,y.position.y=-.13,y.hidden=!0;var v=new THREEx.DynamicTexture(250,200);v.context.font="60px 'source-sans-pro'",v.context.strokeStyle="#8500ff",v.drawText("Next",void 0,115,"#8500ff");var R=new THREE.MeshBasicMaterial({map:v.texture,transparent:!0,opacity:0}),M=new THREE.Mesh(T,R);M.position.z=.01,M.hidden=!0,y.add(M),r.add(y),t.add(r),Reticulum.add(y,{clickCancelFuse:!1,reticleHoverColor:395015,fuseVisible:!0,fuseDuration:1.5,fuseColor:395015,onGazeOver:function(){0==c&&e(this)},onGazeOut:function(){0==c&&n(this)},onGazeLong:function(){function e(e){e.traverse(function(e){if(e.hidden=!1,e.tut=!0,e.material&&0==e.hey){e.hidden=!0;var n={a:1},t=new TWEEN.Tween(n).to({a:0},1e3);t.onUpdate(function(){e.material.opacity=n.a}),t.start(),setTimeout(function(){e.parent.remove(e)},1e3)}})}if(0==c){if(c=1,2==scene.step)o(this);else if(3==scene.step){scene.children[5].children[0].playing=!1,scene.children[5].children[1].playing=!1,scene.children[5].children[2].playing=!1,scene.children[5].children[3].playing=!1,Reticulum.remove(scene.children[4].children[2].children[2].children[2]),Reticulum.remove(scene.children[4].children[3].children[2].children[2]),Reticulum.remove(scene.children[4].children[4].children[2].children[2]),Reticulum.remove(scene.children[4].children[5].children[2].children[2]),Reticulum.remove(scene.children[5].children[0].children[0]),Reticulum.remove(scene.children[5].children[1].children[0]),Reticulum.remove(scene.children[5].children[2].children[0]),Reticulum.remove(scene.children[5].children[3].children[0]),setTimeout(function(){e(scene.children[4]),e(scene.children[5])},4500),scene.children[4].traverse(function(e){if(e.material&&1==e.material.opacity){var n={a:1},t=new TWEEN.Tween(n).to({a:0},1e3);t.onUpdate(function(){e.material.opacity=n.a}),t.start()}});var n={a:1},t=new TWEEN.Tween(n).to({a:.001},1e3);t.onUpdate(function(){scene.children[5].children[0].scale.set(n.a,n.a,n.a),scene.children[5].children[1].scale.set(n.a,n.a,n.a),scene.children[5].children[2].scale.set(n.a,n.a,n.a),scene.children[5].children[3].scale.set(n.a,n.a,n.a)}),t.start(),setTimeout(function(){scene.step=0,drawMusic()},1e3)}c=0}}}),t.traverse(function(e){if(e.material&&0==e.material.opacity&&e.hidden){e.hidden=!1;var n={a:0},t=new TWEEN.Tween(n).to({a:1},1500);t.onUpdate(function(){e.material.opacity=n.a}),t.start()}})}function o(e){scene.step=3,Reticulum.remove(e.parent.parent.parent.children[2].children[1].children[2]),Reticulum.remove(e.parent.parent.parent.children[3].children[1].children[2]),Reticulum.remove(e.parent.parent.parent.children[4].children[1].children[2]),Reticulum.remove(e.parent.parent.parent.children[5].children[1].children[2]),i(r.children[3]),i(r.children[4]),i(r.children[5]),i(r.children[2]),setTimeout(function(){a(r.children[3],"To loop a sound, first look at it,","then select a tempo for the loop."),a(r.children[4],"To loop a sound, first look at it,","then select a tempo for the loop."),a(r.children[5],"To loop a sound, first look at it,","then select a tempo for the loop."),a(r.children[2],"To loop a sound, first look at it,","then select a tempo for the loop.")},1500)}var r=new THREE.Group;r.name="prairie";var c=0,s=new THREE.HemisphereLight(8685445,3947833,2);r.add(s);var l=new THREE.HemisphereLight(14649529,2631720,0);r.add(l);var d=new THREE.DirectionalLight(16777215,0);d.position.set(0,-10,0),scene.add(d),s=new THREE.DirectionalLight(16777215,0),s.position.copy(camera.position),scene.add(s);for(var h=0;4>h;h++){var p=new THREE.Group;p.position.z=-1,r.add(p);var u=new THREE.CircleGeometry(.07,50),E=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:1});boardOnebutton=new THREE.Mesh(u,E),boardOnebutton.position.z=.02,boardOnebutton.position.y=-.13,p.add(boardOnebutton);var T=new THREE.PlaneGeometry(.1,.08),f=new THREEx.DynamicTexture(250,200);f.context.font="60px 'source-sans-pro'",f.context.strokeStyle="#8500ff",f.drawText("Start",void 0,115,"#8500ff");var m=new THREE.MeshBasicMaterial({map:f.texture,transparent:!0,opacity:1}),w=new THREE.Mesh(T,m);w.position.z=.01,boardOnebutton.add(w);var x=new THREE.PlaneGeometry(.2,.08),y=new THREEx.DynamicTexture(2500,1e3);y.context.font="1000px 'fira-sans-2'",y.context.strokeStyle="#ffffff",y.drawText("stitch",void 0,900,"#ffffff");var v=new THREE.MeshBasicMaterial({map:y.texture,transparent:!0}),R=new THREE.Mesh(x,v);R.material.color.r=255,R.material.color.g=255,R.material.color.b=255,R.position.z=.15,R.position.y=.13,p.add(R);var H=new THREE.PlaneGeometry(.4,.15),b=new THREE.MeshBasicMaterial({transparent:!0,opacity:0}),M=new THREE.Mesh(H,b);M.position.z=.05,M.position.y=.03,p.add(M);var z=new THREE.PlaneGeometry(.4,.15),g=new THREEx.DynamicTexture(2500,1e3);g.context.font="150px 'source-sans-pro'",g.context.strokeStyle="#ffffff",g.drawText("Look at the button to start the tutorial",void 0,600,"white");var G=new THREE.MeshBasicMaterial({map:g.texture,transparent:!0}),N=new THREE.Mesh(z,G);N.material.color.r=255,N.material.color.g=255,N.material.color.b=255,N.position.z=.01,M.add(N);var U=0;Reticulum.add(boardOnebutton,{clickCancelFuse:!1,reticleHoverColor:395015,fuseVisible:!0,fuseDuration:1.5,fuseColor:395015,onGazeOver:function(){0==U&&e(this)},onGazeOut:function(){0==U&&n(this)},onGazeLong:function(){0==U&&(U=1,t(this))}}),1==h&&(p.position.z=0,p.position.x=1,p.rotation.y=-1.5708),2==h&&(p.position.z=0,p.position.x=-1,p.rotation.y=1.5708),3==h&&(p.position.z=1,console.log("hey"),p.rotation.y=3.14159)}scene.add(r)}function createTutTempoMenu(e){function n(e){var n={x:1},t=new TWEEN.Tween(n).to({x:.01},500),i={z:-3.14159},a=new TWEEN.Tween(i).to({z:0},500),o={y:.5},r=new TWEEN.Tween(o).to({y:0},500),c={x:.5},s=new TWEEN.Tween(c).to({x:0},500),l={y:-.5},d=new TWEEN.Tween(l).to({y:0},500),h={x:-.5},p=new TWEEN.Tween(h).to({x:0},500);t.onUpdate(function(){e.children[0].scale.set(n.x,n.x,n.x),e.children[1].scale.set(n.x,n.x,n.x),e.children[2].scale.set(n.x,n.x,n.x),e.children[3].scale.set(n.x,n.x,n.x)}),a.onUpdate(function(){e.rotation.z=i.z}),a.start(),r.onUpdate(function(){e.children[0].position.y=o.y}),r.start(),s.onUpdate(function(){e.children[1].position.x=c.x}),s.start(),d.onUpdate(function(){e.children[2].position.y=l.y}),d.start(),p.onUpdate(function(){e.children[3].position.x=h.x}),p.start(),setTimeout(function(){e.children[0].visible=!1,e.children[1].visible=!1,e.children[2].visible=!1,e.children[3].visible=!1},500)}for(var t=window[e.sound],i=new THREE.Group,a=0;4>a;a++){var o=new THREE.CircleGeometry(.2,32),r=new THREE.MeshBasicMaterial({color:8716543,transparent:!0,opacity:.75}),c=new THREE.Mesh(o,r);c.buttonId=a;var s=new THREE.CircleGeometry(.033,32),l=new THREE.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.75}),d=new THREE.Mesh(s,l);d.scale.set;var h=new THREE.Group;switch(a){case 0:d.position.y=-.03;break;case 1:var p=new THREE.Mesh(s,l);d.position.x=-.08,p.position.x=.04,h.add(p);break;case 2:var p=new THREE.Mesh(s,l),u=new THREE.Mesh(s,l);d.position.y=.08,p.position.x=-.07,u.position.x=.07,p.position.y=-.02,u.position.y=-.02,h.add(p),h.add(u);break;case 3:var p=new THREE.Mesh(s,l),u=new THREE.Mesh(s,l),E=new THREE.Mesh(s,l);d.position.x=-.07,p.position.x=.07,u.position.y=-.07,E.position.y=.07,h.position.x=.02,h.add(p),h.add(u),h.add(E)}h.add(d),h.position.z=.1,c.add(h),Reticulum.add(c,{onGazeOver:function(){if(i.parent.tempoVisible){this.parent.parent.hovered=!0;var e={x:1,y:1,a:1},n=new TWEEN.Tween(e).to({x:1.4,y:1.4,a:1},750).easing(TWEEN.Easing.Elastic.Out),t=this;n.onUpdate(function(){t.scale.x=e.x,t.scale.y=e.y,t.material.opacity=e.a}),n.start()}},onGazeOut:function(){if(this.parent.parent.hovered=!1,i.parent.tempoVisible){var e={x:1.4,y:1.4,a:1},n=new TWEEN.Tween(e).to({x:1,y:1,a:1},750).easing(TWEEN.Easing.Elastic.Out),t=this;n.onUpdate(function(){t.scale.x=e.x,t.scale.y=e.y,t.material.opacity=e.a}),n.start()}},onGazeLong:function(){console.log(this.parent.parent.children[2]),n(this.parent.parent.children[2]),playLoopedSound(t,this)}}),i.add(c)}e.add(i),e.hasTempo=!0}
function doneCallback(){drawPrairie()}function animate(e){Math.min(e-lastRender,500);lastRender=e,Reticulum.update(),controls.update(),camera.updateMatrixWorld(),manager.render(scene,camera,e),requestAnimationFrame(animate),updateParticles(),TWEEN.update(e)}function onResize(e){effect.setSize(window.innerWidth,window.innerHeight),camera.aspect=window.innerWidth/window.innerHeight,camera.updateProjectionMatrix()}var renderer=new THREE.WebGLRenderer({antialias:!1});renderer.setPixelRatio(window.devicePixelRatio),renderer.setClearColor(new THREE.Color(12500670,1)),document.body.appendChild(renderer.domElement).className="app";var scene=new THREE.Scene;scene.fog=new THREE.FogExp2(12500670,.001);var camera=new THREE.PerspectiveCamera(75,window.innerWidth/window.innerHeight,.1,15e3),controls=new THREE.VRControls(camera),effect=new THREE.VREffect(renderer);effect.setSize(window.innerWidth,window.innerHeight);var params={hideButton:!1,isUndistorted:!0},manager=new WebVRManager(renderer,effect,params),floorMaterial=new THREE.MeshLambertMaterial({color:16777215,wireframe:!0,transparent:!0,opacity:.2,overdraw:.5}),floorGeometry=new THREE.PlaneGeometry(1e4,1e4,100,100),floor=new THREE.Mesh(floorGeometry,floorMaterial);floor.position.y=-100,floor.rotation.x=Math.PI/2,scene.add(floor),Reticulum.init(camera,{proximity:!1,clickevents:!1,near:null,far:null,reticle:{visible:!0,restPoint:.9,color:16777215,innerRadius:1e-4,outerRadius:.004,hover:{color:16777215,innerRadius:.0101,outerRadius:.014,speed:3,vibrate:0}},fuse:{visible:!0,duration:1,color:16777215,innerRadius:.03,outerRadius:.035,vibrate:0,clickCancelFuse:!1}}),scene.add(camera);var check_interval=100,count=0,html=$("html"),font_loaded_check_interval,check_load_status=function(e){return html.hasClass("wf-active")?(font_loaded_check_interval&&(clearInterval(font_loaded_check_interval),font_loaded_check_interval=null),e.call(this),!0):(count++,!1)};check_load_status(doneCallback)||(font_loaded_check_interval=setInterval(function(){check_load_status(doneCallback)},check_interval));var lastRender=0;animate(performance?performance.now():Date.now()),window.addEventListener("resize",onResize,!0),window.addEventListener("vrdisplaypresentchange",onResize,!0);