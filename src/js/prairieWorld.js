...
function drawPrairie() {
  ...
  var prairieWorld = new THREE.Group();
  prairieWorld.name = 'prairie';
  ...
  for (var i = 0; i < 4; i++) {
    ...
    boardOnebutton = new THREE.Mesh(geometryButton, materialButton);
    ...
    // text.material.color.r = 133;
    // text.material.color.g = 0;
    // text.material.color.b = 255;
    ...
    function stepTwo(el) {
      ...
      hideChildrenObjects(prairieWorld.children[3]);
      hideChildrenObjects(prairieWorld.children[4]);
      hideChildrenObjects(prairieWorld.children[5]);
      hideChildrenObjects(prairieWorld.children[2]);

      setTimeout(function() {        
        Reticulum.remove(prairieWorld.children[3].children[0]);
        Reticulum.remove(prairieWorld.children[4].children[0]);
        Reticulum.remove(prairieWorld.children[5].children[0]);
        Reticulum.remove(prairieWorld.children[2].children[0]);
      }, 500);

      setTimeout(function() {
        updateShowText(prairieWorld.children[3], 'In stitch, each sound is represented by a 3D shape.', 'You can select and play them just by looking at them.');
        updateShowText(prairieWorld.children[4], 'In stitch, each sound is represented by a 3D shape.', 'You can select and play them just by looking at them.');
        updateShowText(prairieWorld.children[5], 'In stitch, each sound is represented by a 3D shape.', 'You can select and play them just by looking at them.');
        updateShowText(prairieWorld.children[2], 'In stitch, each sound is represented by a 3D shape.', 'You can select and play them just by looking at them.');
      }, 1500);
    ...
    function stepThree(el) {
      ...
      //console.log(el.parent.parent.parent.children[2].children[1].children[2]);
      ...
      setTimeout(function() {
        updateShowText(prairieWorld.children[3], 'To loop a sound, first look at it,', 'then select a tempo for the loop.');
        updateShowText(prairieWorld.children[4], 'To loop a sound, first look at it,', 'then select a tempo for the loop.');
        updateShowText(prairieWorld.children[5], 'To loop a sound, first look at it,', 'then select a tempo for the loop.');
        updateShowText(prairieWorld.children[2], 'To loop a sound, first look at it,', 'then select a tempo for the loop.');

        //console.log(prairieWorld.children[3]);
        var button;
        //Reticulum.remove()
